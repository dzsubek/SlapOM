...
abstract class EntityMap
{
    ...
    public function find($filter = null, $dn_suffix = null, $limit = 0, Array $fields = null, $multiLevel = true)
    {
        ...
        $collection = $this->connection->search($this, $dn, $filter, is_null($fields) ? $this->getSearchFields() : $fields, $limit, $multiLevel);
